define([], function () {
  return {
    ...
    ServiceApiUrlAF: "URL Azure function",
    HealthcheckApiUrl: "URL HealthcheckApiUrl",
    GisMapUrl: "URL GisMapUrl",
    ...
    "SendEmailURL": "Send Email URL",
    "SendEmailKey": "Send Email API Key",
  };
});
